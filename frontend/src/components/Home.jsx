...
function Home() {
    ...
    const todoDelete = async(id) =>{
        try{
            const response = await axios.delete(`http://localhost:4001/todo/delete/${id}`,{
                withCredentials:true
            })
  ...
  return (
    <div className=" my-10 bg-gray-100 max-w-lg lg:max-w-xl rounded-lg shadow-lg mx-8 sm:mx-auto p-6">
        ...
        <div className='flex mb-4'>
            ...
            <button  onClick={todoCreate}  className='bg-blue-600 border rounded-r-md text-white px-4 py-2 hover:bg-blue-900 duration-300'>Add Todo</button>
        </div>
        {loading ? (
